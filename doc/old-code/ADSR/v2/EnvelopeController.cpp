 ...
 */
EnvelopeController::EnvelopeController(int a, int d, int s, int r){
	Initialiseer();
	mA = a;
	mH = 0;
	mD = d;
...
EnvelopeController::EnvelopeController(int a, int h, int d, int s, int r){
	Initialiseer();
	mA = a;
	mH = h;
	mD = d;
...
EnvelopeController::EnvelopeController(int a, int h, int d, int s, int r, bool loop){
	Initialiseer();
	mA = a;
	mH = h;
	mD = d;
...
void EnvelopeController::Initialiseer(){
	mResolution = 4096;
	mA = 2050;
	mH = 506;
	mD = 2050;
...
void EnvelopeController::SetResolution(int resolution){

	mResolution = resolution;
}


int EnvelopeController::GetResolution(){
 ...
 */
void EnvelopeController::SetAttackTime(const int a){

	mA = a;
}

int EnvelopeController::GetAttackTime(){
 ...
 */
void EnvelopeController::SetHoldTime(const int h){

	mH = h;
}
int EnvelopeController::GetHoldTime(){
 ...
 */
void EnvelopeController::SetDecayTime(const int d){

	mD=d;
}
int EnvelopeController::GetDecayTime(){
 ...
 */
void EnvelopeController::SetSustainLevel(const int s){

	mS=s;
}
int EnvelopeController::GetSustainLevel(){
 ...
 */
void EnvelopeController::SetReleaseTime(const int r){

	mR=r;
}
int EnvelopeController::GetReleaseTime(){
 ...
 * D -> S
 */
void EnvelopeController::GateOpen(){
 ...
 */
void EnvelopeController::GateClose(){
 ...
 * </ul>
 */
float EnvelopeController::GetValue(){
 ...
 */
Phase EnvelopeController::GetPhase(){
 ...
 */
String EnvelopeController::GetPhaseName(){
	return mPhaseName[mPhase];
}

long EnvelopeController::GetPhaseStart(){
	return mPhaseStart;
}

long EnvelopeController::GetPhaseTime(){
	return mPhaseTime;
}

void EnvelopeController::SetLoop(bool loop){
 ...
 * </ul>
 */
Phase EnvelopeController::NextPhase(){
 ...
 * </ul>
 */
float EnvelopeController::GetPhaseValue(Phase phase, long t){
 ...
 */
long EnvelopeController::GetPhaseTimeFromValue(Phase phase){
	long returnvalue;
	if (phase == A)
	{
