...
| FW-FX-4 | 2 | ✅ | **Effectenbatch 2026-09-25 (fw 0.5.71):** stereo tape echo met cross-feedback, vintage digitale echo (12-bit, modulatie, stereo), BBD-chorus/flanger (mono → stereo), ringmodulator (clean/diode, externe carrier) en analoge octaver (OC-2-flip-flop, CV op de niveaus). Kernels in `mmb_dsp`, wasm-spiegels, panelen, Solo ▾-combinaties; op de Teensy gemeten. Open ideeën: pitch-shifter/harmonizer (granulair of PSOLA), plaat-/veerreverb, tremolo/vibrato-pedaal, phaser stereo. |
