...
#ifdef SIN_DELTA
__attribute__((section(".dmabuffers"))) int32_t sintab[SIN_N_SAMPLES << 1];  // MMB: RAM2, DTCM-stack sparen
#else
__attribute__((section(".dmabuffers"))) int32_t sintab[SIN_N_SAMPLES + 1];  // MMB: RAM2
#endif
