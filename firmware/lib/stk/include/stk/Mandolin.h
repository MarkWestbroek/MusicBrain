...
#include "Instrmnt.h"
#include "Twang.h"
#include "MemoryWvIn.h" // MMB: FileWvIn vervangen — geen bestandssysteem op Teensy
...
class Mandolin : public Instrmnt
{
  ...
  */
  ...
  Twang strings_[2];
  MemoryWvIn soundfile_[12]; // MMB: samples zitten als C-arrays in flash (MandolinData.h)
