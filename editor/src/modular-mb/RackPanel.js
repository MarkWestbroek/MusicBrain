...
function ModuleSidebar({ rack, modules, types }) {
    ...
    return (_jsxs("section", { style: {
        ...
        }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }, children: [_jsxs("h3", { style: { margin: 0, fontSize: 13, textTransform: 'uppercase', color: '#374151' }, children: ["Modules niet in rack (", available.length, ")"] }), _jsxs("label", { style: { fontSize: 12, marginLeft: 'auto' }, children: ["Plaats in rij:", _jsx("select", { value: pickedRow, onChange: (e) => setPickedRow(Number(e.target.value)), style: { marginLeft: 4, fontSize: 12 }, children: Array.from({ length: rack.rows }).map((_, i) => _jsx("option", { value: i, children: i + 1 }, i)) })] })] }), available.length === 0 && (_jsx("p", { style: { color: '#6b7280', fontSize: 13 }, children: "Alle modules zijn al geplaatst. Maak nieuwe modules aan in de Modules-tab." })), _jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 10 }, children: available.map((m) => {
