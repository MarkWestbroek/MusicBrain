...
| musicbrain-matrix | 0.1 | **in ontwerp** (ERC 0, netcheck OK, plaatsing af — routen moet nog) | 8-stemmige audio-patchmatrix: 115×140, 8× MT8816 DIP-40 (voorraad Mark, sockets) volledig parallel = broadcast; 8 IN-/16 UIT-bussen (1×10 jack8-contract); 2× 74AHCT595 aan buskabel-SPI (PinSocket 2×12); VDD +6/VEE −6 (7806/7906), V5-logic (78L05); pinout geverifieerd tegen Mitel-datasheet | freerouting (THT, 2 lagen proberen) + DRC + fab; DIP-sockets + MT8816's zelf plaatsen | | | |
