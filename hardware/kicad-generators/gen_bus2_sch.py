"""Generate musicbrain-busboard-v2.kicad_sch — v2 per doc/busboard-v2-plan.md.

v2 t.o.v. v1.1: CS via 74HC154-decoder (16 CS), IRQ via 2x74HC165+1G125
(gatein8-recept), expansieheader 2x13 (gebufferd via 74LVC245), MIDI 2xIN/1xUIT,
CAN3-transceiver, codec-header (I2S1 TDM), TUNE-IN-conditionering, 2x delegate-UART.
Slot/hub-pinout ongewijzigd.
"""
import os, sys
...
def uid():
    _uid[0] += 1
    return f"c2000001-0000-4000-8000-{_uid[0]:012d}"
...
tpin_label(21, "D29")       # D29 vrij -> EXP (TX7)
...
tpin_label(30, "D38")
tpin_label(31, "D39")
tpin_label(32, "SPARE1")    # D40 CONVST
...
# ============ slots J1..J6 (pinout ONGEWIJZIGD) ============
...
# ============ teksten ============
items.append('''  (text "MusicBrain SPI-busboard v2 - Teensy 4.1 backplane" (exclude_from_sim no) (at 20.32 20.32 0)
    (effects (font (size 2.54 2.54) bold) (justify left)))''')
items.append('''  (text "v2: CS via 74HC154 (16 CS), IRQ via 2x74HC165 (uitlezen: decoder Y14=IRQSTAT,\\nRC-~PL-puls, 1G125 op MISO). Expansieheader J21 -> 2e segment (CS9-14, IRQ7-12,\\ngebufferde SCLK/MOSI/LDAC/CONVST/RST). MIDI 2xIN/1xUIT, CAN3, codec-I2S1, TUNE-IN.\\nSlot/hub-pinout ONGEWIJZIGD t.o.v. v1 - alle kaarten passen." (exclude_from_sim no) (at 20.32 285 0)
    (effects (font (size 1.27 1.27)) (justify left)))''')
items.append('''  (text "Spec: doc/spi-bus-spec.md + doc/busboard-v2-plan.md\\n\\nSlot pinout (2x10):\\n  1 GND      2 +12V\\n  3 GND      4 -12V\\n  5 GND      6 +3V3\\n  7 SCLK     8 GND\\n  9 MOSI    10 GND\\n 11 MISO    12 GND\\n 13 CS*     14 GND\\n 15 LDAC    16 IRQ*\\n 17 SDA     18 SCL\\n 19 SPARE1  20 SPARE2\\n  (* = geografisch per slot)" (exclude_from_sim no) (at 20.32 200.66 0)
    (effects (font (size 1.27 1.27)) (justify left)))''')
...
doc = f'''(kicad_sch
  ...
  (title_block
    ...
    (comment 1 "v2: 74HC154 CS-decoder + 74HC165 IRQ-keten + expansieheader; MIDI/CAN/codec/TUNE")
    (comment 2 "Leidend: doc/spi-bus-spec.md + doc/busboard-v2-plan.md")
    (comment 3 "Slot/hub-pinout identiek aan v1 - alle bestaande kaarten passen")
  )
  (lib_symbols
{libs}
  )
